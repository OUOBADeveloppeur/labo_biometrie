...
public class EasyActionbar extends RelativeLayout {
    ...
    private void init() {
        ...
        //初始化左侧容器
        RelativeLayout.LayoutParams leftContainerLayoutParams = new RelativeLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, DPPX.dip2px(getContext(), containerHeight));
        ...
        //初始化右侧容器
        RelativeLayout.LayoutParams rightContainerLayoutParams = new RelativeLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, DPPX.dip2px(getContext(), containerHeight));
        ...
        //初始化中部容器
        RelativeLayout.LayoutParams centerContainerLayoutParams = new RelativeLayout.LayoutParams(LinearLayout.LayoutParams.WRAP_CONTENT, DPPX.dip2px(getContext(), containerHeight));
    ...
    private ImageView buildCustomImageView(int res) {
        ImageView imageView = new ImageView(getContext());
        RelativeLayout.LayoutParams lp =new LayoutParams(ViewGroup.LayoutParams.WRAP_CONTENT, DPPX.dip2px(getContext(), containerHeight));
    ...
    private TextView buildTextView(String str) {
        return buildTextView(str, Config.DEFULT_TEXT_SIZE);
    }

    //构建text
    private TextView buildEventTextView(String str) {
        return buildEventTextView(str, Config.DEFULT_TEXT_SIZE-2);
    }
    ...
    private TextView buildTextView(String str,int size) {
        ...
        int color = isLight()?R.color.BASE_BLACK:R.color.UI_TEXT;
    ...
    private TextView buildEventTextView(String str,int size) {
        ...
        textView.setTextSize(COMPLEX_UNIT_DIP, size);
        textView.setText(str);
        int color = isLight()?R.color.BASE_BLACK:R.color.UI_MAIN;
        textView.setTextColor(getResources().getColor(color));
        return textView;
    }
    ...
    public void imgTitleStyle(String title,int resId,OnClickListener onClickListener) {
        titleStyle(title);
        ImageView backView = buildCustomImageView(resId);
