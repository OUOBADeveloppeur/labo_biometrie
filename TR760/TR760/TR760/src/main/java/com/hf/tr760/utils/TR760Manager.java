...
public class TR760Manager {
    ...
    public void fingerprintPower(boolean trigger){
        String devName = Build.MODEL;
        Log.d(TAG, "fingerprintPower:" + devName + " open:" + trigger);
        int gpio = 86;
        this.mCommonApi.setGpioDir(gpio, 1);
        this.mCommonApi.setGpioOut(gpio, trigger ? 1 : 0);
